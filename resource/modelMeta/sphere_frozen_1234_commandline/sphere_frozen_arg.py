...
class Sphere:
    ...
    def build(self):
        weights = {
            'c1_1': weight_variable([3, 3, 3, 64], name='W_conv11', trainable=f1),
            'c1_2': weight_variable([3, 3, 64, 64], name='W_conv12', trainable=f1),
            'c1_3': weight_variable([3, 3, 64, 64], name='W_conv13', trainable=f1),

            'c2_1': weight_variable([3, 3, 64, 128], name='W_conv21', trainable=f2),
            'c2_2': weight_variable([3, 3, 128, 128], name='W_conv22', trainable=f2),
            'c2_3': weight_variable([3, 3, 128, 128], name='W_conv23', trainable=f2),
            'c2_4': weight_variable([3, 3, 128, 128], name='W_conv24', trainable=f2),
            'c2_5': weight_variable([3, 3, 128, 128], name='W_conv25', trainable=f2),

            'c3_1': weight_variable([3, 3, 128, 256], name='W_conv31', trainable=f3),
            'c3_2': weight_variable([3, 3, 256, 256], name='W_conv32', trainable=f3),
            'c3_3': weight_variable([3, 3, 256, 256], name='W_conv33', trainable=f3),
            'c3_4': weight_variable([3, 3, 256, 256], name='W_conv34', trainable=f3),
            'c3_5': weight_variable([3, 3, 256, 256], name='W_conv35', trainable=f3),
            'c3_6': weight_variable([3, 3, 256, 256], name='W_conv36', trainable=f3),
            'c3_7': weight_variable([3, 3, 256, 256], name='W_conv37', trainable=f3),
            'c3_8': weight_variable([3, 3, 256, 256], name='W_conv38', trainable=f3),
            'c3_9': weight_variable([3, 3, 256, 256], name='W_conv39', trainable=f3),
