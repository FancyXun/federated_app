...
public class Pcn2 extends PcnModel {
     ...
     * @param activity
     */
    public Pcn2(Activity activity, Device device, int numThreads)
            throws IOException {
...
//    }
    ...
    public Map<Integer,Object> stage2(float[][][][] intputArr, int sampleNum) {
...
//    tflite.run(bf, outputProbabilityBuffer.getBuffer().rewind());
        ...
        float[][] outputr = new float[sampleNum][3];
