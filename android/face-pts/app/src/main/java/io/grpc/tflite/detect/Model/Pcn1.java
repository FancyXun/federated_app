...
public class Pcn1 extends PcnModel {
     ...
     * @param activity
     */
    public Pcn1(Activity activity, Device device, int numThreads)
            throws IOException {
...
//    }
    ...
    public Map<Integer,Object> stage1(float[][][][] intputArr, int sampleNum) {
...
//    tflite.run(bf, outputProbabilityBuffer.getBuffer().rewind());
        ...
        float[][][][] outputc = new float[sampleNum][1][1][2];
        float[][][][] outputr = new float[sampleNum][1][1][2];
        float[][][][] outputb = new float[sampleNum][1][1][3];
